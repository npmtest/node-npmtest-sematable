...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sematable/node_modules/sematable/lib/SelectRow.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sematable/node_modules/sematable/lib/SelectRow.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sematable/node_modules/sematable/lib/</a> &#187; SelectRow.js</div>
</div>
<div class="body">
...
var propTypes = {
  ...
  isEnabled: _react.PropTypes.func,
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function SelectRow() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SelectRow);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (SelectRow.__proto__ || Object.getPrototypeOf(SelectRow)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var checked = isSelected(row);</span>
<span class="cstat-no" title="statement not covered" >      if (!isEnabled || isEnabled(row)) {</span>
<span class="cstat-no" title="statement not covered" >        if (CheckboxComponent) {</span>
<span class="cstat-no" title="statement not covered" >          return _react2.default.createElement(CheckboxComponent, {</span>
            type: "checkbox",
            checked: checked,
            onChange: <span class="fstat-no" title="function not covered" >function onChange() {</span>
<span class="cstat-no" title="statement not covered" >              return onRowCheckedChange(row);</span>
            }
          });
        }
