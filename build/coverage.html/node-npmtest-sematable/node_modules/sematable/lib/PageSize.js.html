...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sematable/node_modules/sematable/lib/PageSize.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sematable/node_modules/sematable/lib/PageSize.js</span></h1>
    <h2>
        
        Statements: <span class="metric">74.51% <small>(38 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sematable/node_modules/sematable/lib/</a> &#187; PageSize.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function PageSize() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, PageSize);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (PageSize.__proto__ || Object.getPrototypeOf(PageSize)).apply(this, arguments));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              return _onChange(parseInt(e.target.value, 10));</span>
            },
            value: pageSize,
          ...
          _lodash2.default.map(pageSizes, <span class="fstat-no" title="function not covered" >function (size, i) {</span>
<span class="cstat-no" title="statement not covered" >            return _react2.default.createElement(</span>
              'option',
              {
                value: size,
