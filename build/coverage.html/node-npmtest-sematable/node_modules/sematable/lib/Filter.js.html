...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sematable/node_modules/sematable/lib/Filter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sematable/node_modules/sematable/lib/Filter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">62.07% <small>(36 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">34.15% <small>(14 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sematable/node_modules/sematable/lib/</a> &#187; Filter.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Filter.__proto__ || Object.getPrototypeOf(Filter)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Filter, [{
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (nextProps.value !== value || nextProps.options !== options) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var defaultPlaceholder = hasFilterable ? 'Search by text or tags' : 'Search by text';</span>
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(_reactSelect.Creatable, {</span>
        className: className,
        options: options,
        noResultsText: 'Type text to search, press Enter to save as filter',
        placeholder: placeholder || defaultPlaceholder,
        promptTextCreator: <span class="fstat-no" title="function not covered" >function promptTextCreator(txt) {</span>
<span class="cstat-no" title="statement not covered" >          return 'Search for \'' + txt + '\'';</span>
        },
        onChange: <span class="fstat-no" title="function not covered" >function onChange(selected) {</span>
<span class="cstat-no" title="statement not covered" >          return _onChange(selected);</span>
        },
        onInputChange: <span class="fstat-no" title="function not covered" >function onInputChange(text) {</span>
<span class="cstat-no" title="statement not covered" >          onTextChange(text);</span>
<span class="cstat-no" title="statement not covered" >          return text;</span>
        },
        onBlurResetsInput: false,
        onCloseResetsInput: false,
        newOptionCreator: <span class="fstat-no" title="function not covered" >function newOptionCreator(_ref) {</span>
<span class="cstat-no" title="statement not covered" >          var label = _ref.label;</span>
<span class="cstat-no" title="statement not covered" >          return (0, _common.createTextFilter)(label);</span>
        },
        value: value,
        multi: true,
        style: {
