...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sematable/node_modules/sematable/lib/Table.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sematable/node_modules/sematable/lib/Table.js</span></h1>
    <h2>
        
        Statements: <span class="metric">62.5% <small>(45 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sematable/node_modules/sematable/lib/</a> &#187; Table.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Table.__proto__ || Object.getPrototypeOf(Table)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Table, [{
    key: 'render',
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var className = this.props.className || 'table-sm table-striped table-hover';</span>
...
<span class="cstat-no" title="statement not covered" >      var visibleColumnsLength = visibleColumns.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var NoDataContent = NoDataComponent || _TableNoData2.default;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              if (col.sortable &amp;&amp; !col.hidden) {</span>
<span class="cstat-no" title="statement not covered" >                return _react2.default.createElement(_SortableHeader2.default, _extends({</span>
                  key: col.key,
                  title: col.title
                }, headers[col.key]));
              }
<span class="cstat-no" title="statement not covered" >              return _react2.default.createElement(</span>
        ...
        _react2.default.createElement(
          'tbody',
          null,
          data.map(<span class="fstat-no" title="function not covered" >function (row) {</span>
<span class="cstat-no" title="statement not covered" >            return _react2.default.createElement(_TableRow2.default, _extends({ key: _lodash2.default.get(row, primaryKey) }, _this2.props, { row: row }));</span>
          }),
